        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attestations_Subject_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subject",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Attestations_AspNetUsers_TeacherId",
            ...
            migrationBuilder.CreateTable(
                name: "TeacherSubjectMappingModel",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherSubjectMappingModel", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TeacherSubjectMappingModel_Subject_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subject",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupSubjectMappingModel", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupTeacherMappingModel", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GroupTeacherMappingModel_Group_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Group",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "AttestationRecords",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    AttestationId = table.Column<int>(nullable: false),
                    ContingentOfStudents = table.Column<string>(nullable: true),
                    Date = table.Column<DateTime>(nullable: false),
                    GroupId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttestationRecords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AttestationRecords_Attestations_AttestationId",
                        column: x => x.AttestationId,
                        principalTable: "Attestations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AttestationRecords_Group_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Group",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Record_Magazine_MagazineId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    AttestationRecordId = table.Column<int>(nullable: false),
                    StudentId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Marks_AttestationRecords_AttestationRecordId",
                        column: x => x.AttestationRecordId,
                        principalTable: "AttestationRecords",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttestationRecords_AttestationId",
                table: "AttestationRecords",
                column: "AttestationId");

            migrationBuilder.CreateIndex(
                name: "IX_AttestationRecords_GroupId",
                table: "AttestationRecords",
                column: "GroupId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attestations_TeacherId",
                table: "Attestations",
                column: "TeacherId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupSubjectMappingModel_GroupId",
                table: "GroupSubjectMappingModel",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupSubjectMappingModel_SubjectId",
                table: "GroupSubjectMappingModel",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupTeacherMappingModel_GroupId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Marks_AttestationRecordId",
                table: "Marks",
                column: "AttestationRecordId");
